...
class ProjectManager:
    ...
    def dev(self):
        ...
        print("🛠️  Iniciando en modo desarrollo...")
        ...
        if gateway_path.exists():
            ...
            print("❌ Gateway no encontrado. Instala primero los servicios.")
    ...
    def status(self):
        ...
        try:
            ...
            print("⚠️  requests no instalado. No se puede verificar servicios.")
